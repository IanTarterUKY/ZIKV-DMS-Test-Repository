...
Read the sites of "strong escape" for each antibody.
These auto-identified sites are what we plot by default for each escape profile:


```python
print(f"Reading sites of strong escape from {config['strong_escape_sites_ZIKV']}")

strong_escape_sites = pd.read_csv(config['strong_escape_sites_ZIKV'])
```

    Reading sites of strong escape from results/escape_profiles/strong_escape_sites_ZIKV.csv


## Read and pad escape fractions data frame
Read the escape fractions.
We only retain the **average** of the libraries for plotting here, not the individual libraries.
Also, we work in the envelope rather than DIII numbering, which means we use `label_site` as `site` (and so rename as such below):
...
wt_prot = str(Bio.SeqIO.read(config['wildtype_sequence_ZIKV'], 'fasta').seq.translate())
...
for name, specs in escape_profiles_config.items():
    ...
    # write the ylimits
    ylims_csv = os.path.join(config['escape_profiles_dir_ZIKV'], f"{name}_stackedlogo_ylims.csv")
    (
    ...
    colors_plotfiles = [(color_col, os.path.join(config['escape_profiles_dir_ZIKV'], f"{name}_stackedlogo.pdf"))]
#    if 'color_by_dms' in specs and specs['color_by_dms']:
#        colors_plotfiles += [('bind_color', os.path.join(config['escape_profiles_dir_ZIKV'], f"{name}_color_by_bind_stackedlogo.pdf")),
#                             ('expr_color', os.path.join(config['escape_profiles_dir_ZIKV'], f"{name}_color_by_expr_stackedlogo.pdf"))]
...
```
    ...
    Drawing 17 profiles using 24 CPUs...


    /project/jdbr310_uksr/ilta223/my_conda/Tyler-escape/lib/python3.8/site-packages/dmslogo/facet.py:196: UserWarning: Tight layout not applied. The left and right margins cannot be made large enough to accommodate all axes decorations.
    /project/jdbr310_uksr/ilta223/my_conda/Tyler-escape/lib/python3.8/site-packages/dmslogo/facet.py:196: UserWarning: Tight layout not applied. The left and right margins cannot be made large enough to accommodate all axes decorations.
    /project/jdbr310_uksr/ilta223/my_conda/Tyler-escape/lib/python3.8/site-packages/dmslogo/facet.py:196: UserWarning: Tight layout not applied. The left and right margins cannot be made large enough to accommodate all axes decorations.
    /project/jdbr310_uksr/ilta223/my_conda/Tyler-escape/lib/python3.8/site-packages/dmslogo/facet.py:196: UserWarning: Tight layout not applied. The left and right margins cannot be made large enough to accommodate all axes decorations.
    /project/jdbr310_uksr/ilta223/my_conda/Tyler-escape/lib/python3.8/site-packages/dmslogo/facet.py:196: UserWarning: Tight layout not applied. The left and right margins cannot be made large enough to accommodate all axes decorations.
    ...
    Plotted profile 1 to:
     results/escape_profiles/ZIKV/Z2131_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2131_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_3.png)
    


    
    Plotted profile 2 to:
     results/escape_profiles/ZIKV/Z6161_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z6161_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_5.png)
    


    
    Plotted profile 3 to:
     results/escape_profiles/ZIKV/Z6163_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z6163_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_7.png)
    


    
    Plotted profile 4 to:
     results/escape_profiles/ZIKV/Z3039_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z3039_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_9.png)
    


    
    Plotted profile 5 to:
     results/escape_profiles/ZIKV/Z2029_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2029_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_11.png)
    


    
    Plotted profile 6 to:
     results/escape_profiles/ZIKV/Z2039_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2039_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_13.png)
    


    
    Plotted profile 7 to:
     results/escape_profiles/ZIKV/Z2044_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2044_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_15.png)
    


    
    Plotted profile 8 to:
     results/escape_profiles/ZIKV/Z2103_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2103_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_17.png)
    


    
    Plotted profile 9 to:
     results/escape_profiles/ZIKV/Z3051_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z3051_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_19.png)
    


    
    Plotted profile 10 to:
     results/escape_profiles/ZIKV/Z2212_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2212_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_21.png)
    


    
    Plotted profile 11 to:
     results/escape_profiles/ZIKV/ZV2_stackedlogo.pdf
     results/escape_profiles/ZIKV/ZV2_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_23.png)
    


    
    Plotted profile 12 to:
     results/escape_profiles/ZIKV/ZV16_stackedlogo.pdf
     results/escape_profiles/ZIKV/ZV16_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_25.png)
    


    
    Plotted profile 13 to:
     results/escape_profiles/ZIKV/Z2102_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2102_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_27.png)
    


    
    Plotted profile 14 to:
     results/escape_profiles/ZIKV/Z2208_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z2208_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_29.png)
    


    
    Plotted profile 15 to:
     results/escape_profiles/ZIKV/Z3022_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z3022_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_31.png)
    


    
    Plotted profile 16 to:
     results/escape_profiles/ZIKV/Z6147_stackedlogo.pdf
     results/escape_profiles/ZIKV/Z6147_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_33.png)
    


    
    Plotted profile 17 to:
     results/escape_profiles/ZIKV/ZV67_stackedlogo.pdf
     results/escape_profiles/ZIKV/ZV67_stackedlogo.png.



    
![png](escape_profiles_ZIKV_files/escape_profiles_ZIKV_26_35.png)
