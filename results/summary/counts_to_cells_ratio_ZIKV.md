...
```python
variant_counts = pd.read_csv(config['variant_counts_ZIKV'])
```
...
print(f"First few lines of the data frame, writing entirety to {config['counts_to_cells_csv_ZIKV']}:")
display(HTML(counts_cells.head().to_html(index=False, float_format='{:.2g}'.format)))
counts_cells.to_csv(config['counts_to_cells_csv_ZIKV'], index=False, float_format='%.3g')
```

    First few lines of the data frame, writing entirety to results/counts/ZIKV/counts_to_cells_csv.csv:
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <td>exp1-Z2131-1000-abneg, lib1</td>
      <td>7/31/2025</td>
      <td>exp1</td>
      <td>Z2131</td>
      <td>1000</td>
    ...
    <tr>
      <td>exp1-Z6161-1000-abneg, lib1</td>
      <td>7/31/2025</td>
      <td>exp1</td>
      <td>Z6161</td>
      <td>1000</td>
    ...
    <tr>
      <td>exp1-Z6163-1000-abneg, lib1</td>
      <td>7/31/2025</td>
      <td>exp1</td>
      <td>Z6163</td>
      <td>1000</td>
...
```
    ...
    /tmp/ipykernel_2776100/1580948032.py:14: SettingWithCopyWarning: 
...
![png](counts_to_cells_ratio_ZIKV_files/counts_to_cells_ratio_ZIKV_13_1.png)
...
![png](counts_to_cells_ratio_ZIKV_files/counts_to_cells_ratio_ZIKV_13_3.png)
...
![png](counts_to_cells_ratio_ZIKV_files/counts_to_cells_ratio_ZIKV_13_5.png)
